            ...
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <div class="thumb-info-title"><!-- thumb-info-title begin -->
                        ...
                        <span class="thumb-info-inner"> Andrei </span>
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        <i class="fa fa-user"></i> <span> Email: </span> andrei.bast@gmail.com <br/>
                        <i class="fa fa-flag"></i> <span> Country: </span> Romania <br/>
                        <i class="fa fa-envelope"></i> <span> Contact: </span> N/A <br/>
