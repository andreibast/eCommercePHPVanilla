            ...
            <div class="col-md-9">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form action="customer_register.php" method="post" enctype="multipart/form-data"><!--here are some custom settings-->
...
<?php  //form processing
    ...
    if(isset($_POST['register'])){
        ...
        $c_image_tmp = $_FILES['c_image']['tmp_image'];
        $c_ip = getRealIpUser();
        ...
        if($check_cart>0){
            ...
            //user registers with items in cart
            ...
            //user registers without items in cart
